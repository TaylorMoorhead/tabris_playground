...
const PAGE_CONFIGS = [
  {title: 'Basket', icon: 'https://raw.githubusercontent.com/eclipsesource/tabris-js/master/snippets/resources/page.png'},
  {title: 'Checkout', icon: 'https://raw.githubusercontent.com/eclipsesource/tabris-js/master/snippets/resources/page.png'}
];
...
if (device.platform !== 'windows') {
  new ImageView({
    ...
    image: 'https://raw.githubusercontent.com/eclipsesource/tabris-js/master/snippets/resources/landscape.jpg',
    scaleMode: 'fill'
  }).appendTo(ui.drawer);
}
...
createPage({title: 'Initial Page', icon: 'https://raw.githubusercontent.com/eclipsesource/tabris-js/master/snippets/resources/page.png'}).appendTo(navigationView);
...
function createPage(config) {
  ...
  new Button({
    ...
    PAGE_CONFIGS.push({title: 'Another Page', icon: 'https://raw.githubusercontent.com/eclipsesource/tabris-js/master/snippets/resources/page.png'});
...
new TextView({
  left: 10, top: 300, right: 10,
  text: ' Click menu at top to see drawer',
  alignment: 'center'
}).appendTo(ui.contentView);
